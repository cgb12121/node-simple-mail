...
app.use('/auth', require('./routes/authRoutes').default(authController));
app.use('/emails', require('./routes/emailRoutes').default(emailController));
...
//         await pool.query(`INSERT INTO users (full_name, email, password) VALUES (?, ?, ?)`, [name, email, bcrypt.hash(password, 10)]);
